...
public class RecipesDyes {
	public void addRecipes(CraftingManager var1) {
		for(int var2 = 0; var2 < 16; ++var2) {
			...
			var1.addShapelessRecipe(new ItemStack(Block.planks, 1, BlockPlanks.func_21035_d(var2)), new Object[]{new ItemStack(Item.dyePowder, 1, var2), new ItemStack(Item.itemsList[Block.planks.blockID], 1, 0)});
		}
