...
public class Item {
	...
	public static Item fishSalted = (new ItemFood(119, 8, true)).setIconCoord(11, 7).setItemName("fishSalted");
	public static Item porkstuffer = (new ItemFood(120, 7, true)).setIconCoord(12, 8).setItemName("porkstuffer");
	public static Item fishstuffer = (new ItemFood(121, 7, true)).setIconCoord(12, 9).setItemName("fishstuffer");
	public static Item fleshstuffer = (new ItemFood(119, 6, true)).setIconCoord(13, 9).setItemName("fleshstuffer");
