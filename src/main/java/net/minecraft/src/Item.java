...
public class Item {
	...
	public static Item helmetstone = (new ItemArmor(50, 2, 2, 0)).setIconCoord(2, 0).setItemName("helmetstone");
	public static Item platestone = (new ItemArmor(51, 2, 2, 1)).setIconCoord(2, 1).setItemName("chestplatestone");
