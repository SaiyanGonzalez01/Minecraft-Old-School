...
public class WorldGenBlackstone extends WorldGenerator {
	public boolean generate(World var1, Random var2, int var3, int var4, int var5) {
		if(!var1.isAirBlock(var3, var4, var5)) {
			...
			var1.setBlockWithNotify(var3, var4, var5, Block.blackstone.blockID);
			...
			for(int var6 = 0; var6 < 1500; ++var6) {
				...
				if(var1.getBlockId(var7, var8, var9) == 0) {
					...
					for(int var11 = 0; var11 < 6; ++var11) {
						...
						if(var12 == Block.blackstone.blockID) {
							++var10;
						}
					}

					if(var10 == 1) {
						var1.setBlockWithNotify(var7, var8, var9, Block.blackstone.blockID);
					}
				}
			}
