...
public class Block {
	...
	public static final Block sawdustBlock = (new BlockSand(103, 54)).setHardness(0.5F).setStepSound(soundSandFootstep).setBlockName("sawdustBlock").disableNeighborNotifyOnMetadataChange();
