...
public class Block {
	...
	public static final Block stoneSlab = (new BlockStoneSlab(102, 6)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("stoneSlab");
