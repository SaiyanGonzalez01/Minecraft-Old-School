...
public class Block {
	...
	public static final BlockCrystal salt = (BlockCrystal)(new BlockSalt(104, 78, Material.rock)).setHardness(1.2F).setResistance(1.0F).setStepSound(soundGlassFootstep).setBlockName("salt");
	...
	public static final Block brickMoss = (new Block(118, 173, Material.rock)).setHardness(2.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("brickMoss");
