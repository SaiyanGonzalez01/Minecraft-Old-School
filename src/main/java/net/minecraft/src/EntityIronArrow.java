...
public class EntityIronArrow extends Entity {
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	...
	public EntityIronArrow(World var1) {
		super(var1);
		this.setSize(0.5F, 0.5F);
	}

	public EntityIronArrow(World var1, double var2, double var4, double var6) {
		super(var1);
		this.setSize(0.5F, 0.5F);
	...
	public EntityIronArrow(World var1, EntityLiving var2) {
		super(var1);
		this.owner = var2;
		...
		if(this.inGround) {
			...
			if(var3 != null) {
				if(var3.entityHit != null) {
					if(var3.entityHit.attackEntityFrom(this.owner, 5)) {
