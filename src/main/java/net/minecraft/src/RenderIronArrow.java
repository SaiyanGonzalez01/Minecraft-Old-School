...
public class RenderIronArrow extends Render {
	
	private static final TextureLocation arrowsTexture = new TextureLocation("/item/arrow_iron.png");
	
	public void renderArrow(EntityIronArrow var1, double var2, double var4, double var6, float var8, float var9) {
	...
	public void doRender(Entity var1, double var2, double var4, double var6, float var8, float var9) {
		this.renderArrow((EntityIronArrow)var1, var2, var4, var6, var8, var9);
	}
