...
public class ContainerUpgradeTable extends Container {
	...
	public ContainerUpgradeTable(InventoryPlayer var1, World var2, int var3, int var4, int var5) {
	...
	public boolean isUsableByPlayer(EntityPlayer var1) {
		return this.field_20133_c.getBlockId(this.field_20132_h, this.field_20131_i, this.field_20130_j) != Block.upgradeTable.blockID ? false : var1.getDistanceSq((double)this.field_20132_h + 0.5D, (double)this.field_20131_i + 0.5D, (double)this.field_20130_j + 0.5D) <= 64.0D;
	}
