...
public class EntityIceball extends Entity {
	...
	public EntityIceball(World var1, EntityLiving var2) {
		super(var1);
		this.thrower = var2;
		this.setSize(0.25F, 0.25F);
	...
	public EntityIceball(World var1, double var2, double var4, double var6) {
		super(var1);
