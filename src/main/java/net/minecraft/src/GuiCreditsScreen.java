...
public class GuiErrorScreen extends GuiScreen {
	...
	public void initGui() {
      ...
      this.controlList.add(new GuiButton(301, this.width / 2 - 100, this.height / 6 + 168, var1.translateKey("gui.done")));
	...
	public void drawScreen(int var1, int var2, float var3) {
		...
		this.drawCenteredString(this.fontRenderer, "Oi this is testing!", this.width / 2, this.height / 4 - 60 + 20, 16777215);
		this.drawString(this.fontRenderer, "Minecraft Old-School has run out of memory.", this.width / 2 - 140, this.height / 4 - 60 + 60 + 0, 10526880);
		...
		this.drawString(this.fontRenderer, "To prevent your world from corrupting, your current game has quit.", this.width / 2 - 140, this.height / 4 - 60 + 60 + 63, 10526880);
