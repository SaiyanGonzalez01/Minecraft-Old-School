...
public class SkyTeleporter {
	...
	public boolean func_4106_b(World var1, Entity var2) {
		...
		for(int var11 = var9 - var3; var11 <= var9 + var3; ++var11) {
			...
			for(int var14 = var10 - var3; var14 <= var10 + var3; ++var14) {
				...
				for(int var17 = 127; var17 >= 0; --var17) {
					if(var1.getBlockId(var11, var17, var14) == Block.portalSky.blockID) {
						while(var1.getBlockId(var11, var17 - 1, var14) == Block.portalSky.blockID) {
							--var17;
						}
		...
		if(var4 >= 0.0D) {
			...
			if(var1.getBlockId(var6 - 1, var7, var8) == Block.portalSky.blockID) {
				var22 -= 0.5D;
			}
			...
			if(var1.getBlockId(var6, var7, var8 - 1) == Block.portalSky.blockID) {
				var18 -= 0.5D;
			}
			...
			for(var20 = -1; var20 <= 1; ++var20) {
				for(var21 = 1; var21 < 3; ++var21) {
					for(var22 = -1; var22 < 3; ++var22) {
						...
						var34 = var22 < 0;
						var1.setBlockWithNotify(var23, var24, var25, var34 ? Block.glowStone.blockID : 0);
					}
				}
			}
		}
		...
		for(var20 = 0; var20 < 4; ++var20) {
			...
			for(var21 = 0; var21 < 4; ++var21) {
				for(var22 = -1; var22 < 4; ++var22) {
					...
					var1.setBlockWithNotify(var23, var24, var25, var34 ? Block.glowStone.blockID : Block.portalSky.blockID);
				}
			}
