...
public class Block {
	...
	public static final Block waterStill = (new BlockFlowing(8, Material.water)).setHardness(100.0F).setLightOpacity(3)
			.setBlockName("water");
	public static final Block waterMoving = (new BlockStationary(9, Material.water)).setHardness(100.0F)
			.setLightOpacity(3).setBlockName("water");
	public static final Block lavaStill = (new BlockFlowing(10, Material.lava)).setHardness(0.0F).setLightValue(1.0F)
			.setLightOpacity(255).setBlockName("lava");
	public static final Block lavaMoving = (new BlockStationary(11, Material.lava)).setHardness(100.0F)
	...
	public static final Block blockGold = (new BlockOreBlock(41, 23)).setHardness(3.0F).setResistance(10.0F)
			.setStepSound(soundMetalFootstep).setBlockName("blockGold");
	public static final Block blockSteel = (new BlockOreBlock(42, 22)).setHardness(5.0F).setResistance(10.0F)
	...
	public static final Block blockDiamond = (new BlockOreBlock(57, 24)).setHardness(5.0F).setResistance(10.0F)
	...
	public static final Block pressurePlateStone = (new BlockPressurePlate(70, stone.blockIndexInTexture,
			EnumMobType.mobs)).setHardness(0.5F).setStepSound(soundStoneFootstep).setBlockName("pressurePlate");
	...
	public static final Block pressurePlatePlanks = (new BlockPressurePlate(72, planks.blockIndexInTexture,
			EnumMobType.everything)).setHardness(0.5F).setStepSound(soundWoodFootstep).setBlockName("pressurePlate");
	...
	public static final Block bloodStone = (new BlockBloodStone(87, 103)).setHardness(0.4F)
	...
	public static final Block lightStone = (new BlockLightStone(89, 105, Material.glass)).setHardness(0.3F)
	...
	public static final Block cake = (new BlockCake(92, 121)).setHardness(0.5F).setStepSound(soundClothFootstep)
			.setBlockName("cake");
	public static final Block field_22021_bh = (new BlockRedstoneRepeater(93, false)).setHardness(0.0F)
