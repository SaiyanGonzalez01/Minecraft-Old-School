	...
	private void func_21030_a(World var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		...
		if (var10) {
			...
			for (var11 = 0; var11 < 4; ++var11) {
				...
				} else if (!var1.isBlockOpaqueCube(var12, var3, var13)
	...
	public boolean isPoweringTo(IBlockAccess var1, int var2, int var3, int var4, int var5) {
		if (!this.wiresProvidePower) {
			...
			boolean var6 = isPowerProviderOrWire(var1, var2 - 1, var3, var4)
					|| !var1.isBlockOpaqueCube(var2 - 1, var3, var4) && isPowerProviderOrWire(var1, var2 - 1, var3 - 1, var4);
			boolean var7 = isPowerProviderOrWire(var1, var2 + 1, var3, var4)
					|| !var1.isBlockOpaqueCube(var2 + 1, var3, var4) && isPowerProviderOrWire(var1, var2 + 1, var3 - 1, var4);
			boolean var8 = isPowerProviderOrWire(var1, var2, var3, var4 - 1)
					|| !var1.isBlockOpaqueCube(var2, var3, var4 - 1) && isPowerProviderOrWire(var1, var2, var3 - 1, var4 - 1);
