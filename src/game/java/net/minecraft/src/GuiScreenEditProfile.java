...
public class GuiScreenEditProfile extends GuiScreen {
	...
	public void initGui() {
		...
		//this.username = new GuiTextField(this, this.fontRenderer, this.width / 2 - 20, this.height / 6 + 10, 130, 20,
		//		Profile.getName());
		//this.username.isFocused = true;
		//this.username.setMaxStringLength(16);
		this.usernameField = new GuiDisableButton(this.fontRenderer, this.width / 2 - 20, this.height / 6 + 10, 140, 20,
				EaglerProfile.getName());
	...
	public void drawScreen(int mx, int my, float par3) {
		...
		this.drawString(this.fontRenderer, var1.translateKey("Username"), this.width / 2 - 20, this.height / 6 + 10, 10526880);
		...
		gui.bindTexture();
		if (dropDownOpen) {
			drawTexturedModalRect(skinX + skinWidth - 18, skinY + 3, 16, 240, 16, 16);
		}else {
	...
	protected void keyTyped(char par1, int par2) {
		...
		if (this.usernameField.field_22082_a) this.usernameField.func_22072_a(par1, par2);
		if(par1 == 13) {
		...
		((GuiButton)this.controlList.get(0)).enabled = this.usernameField.func_22071_a().trim().length() > 0;
	}
	
	protected void mouseClicked(int par1, int par2, int par3) {
		super.mouseClicked(par1, par2, par3);

		this.usernameField.func_22069_a(par1, par2, par3);
