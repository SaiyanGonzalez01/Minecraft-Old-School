...
public class ChunkProviderGenerate implements IChunkProvider {
	...
	public void populate(IChunkProvider var1, int var2, int var3) {
		...
		for (var13 = 0; var13 < 1; ++var13) {
			...
			var15 = this.rand.nextInt(16);
			var16 = var5 + this.rand.nextInt(16);
			(new WorldGenMinable(Block.oreRuby.blockID, 4)).generate(this.worldObj, this.rand, var14, var15, var16);
		}
		...
		for (var16 = var4 + 8; var16 < var4 + 8 + 16; ++var16) {
			for (var17 = var5 + 8; var17 < var5 + 8 + 16; ++var17) {
				...
				if (var21 < 0.5D && var20 > 0 && var20 < 128 && this.worldObj.isAirBlock(var16, var20, var17)
						&& this.worldObj.getBlockMaterial(var16, var20 - 1, var17).getIsSolid()
						&& this.worldObj.getBlockMaterial(var16, var20 - 1, var17) != Material.ice) {
