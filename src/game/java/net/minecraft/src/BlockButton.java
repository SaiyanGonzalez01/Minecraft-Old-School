...
public class BlockButton extends Block {
	...
	private int func_22036_h(World var1, int var2, int var3, int var4) {
		return var1.isBlockOpaqueCube(var2 - 1, var3, var4) ? 1
				: (var1.isBlockOpaqueCube(var2 + 1, var3, var4) ? 2
						: (var1.isBlockOpaqueCube(var2, var3, var4 - 1) ? 3
								: (var1.isBlockOpaqueCube(var2, var3, var4 + 1) ? 4 : 1)));
	}
