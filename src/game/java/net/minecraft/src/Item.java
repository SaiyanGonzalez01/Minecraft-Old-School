...
public class Item {
	...
	public static Item bucketWater = (new ItemBucket(70, Block.waterStill.blockID)).setIconCoord(11, 4)
			.setItemName("bucketWater").setContainerItem(bucketEmpty);
	public static Item bucketLava = (new ItemBucket(71, Block.lavaStill.blockID)).setIconCoord(12, 4)
