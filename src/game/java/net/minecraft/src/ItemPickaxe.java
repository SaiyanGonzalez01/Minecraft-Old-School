...
public class ItemPickaxe extends ItemTool {
	private static Block[] blocksEffectiveAgainst = new Block[]{Block.cobblestone, Block.stairDouble, Block.stairSingle, Block.stone, Block.sandStone, Block.cobblestoneMossy, Block.oreIron, Block.blockSteel, Block.oreCoal, Block.blockGold, Block.oreGold, Block.oreDiamond, Block.blockDiamond, Block.ice, Block.bloodStone, Block.oreLapis, Block.blockLapis, Block.oreRedstone, Block.oreRedstoneGlowing, Block.minecartTrack, Block.ice, Block.obsidian, Block.mobSpawner, Block.bloodStone, Block.lightStone, Block.oreRuby, Block.blockRuby, Block.stoneOvenIdle, Block.stoneOvenActive, Block.stoneBrick, Block.dispenser};
